...
$(document).ready(function () {
    ...
    $('.li-about').addClass('open')
    $('.a-aboutE').addClass('active')
...
function GetAgreement() {
    jQuery.axpost('../settingAjax/GetAboutE', "{}", function (data) {
...
function UpdateSport() {
    ...
    jQuery.axpost('../settingAjax/UpdateAboutE', GetData(imgs), function (data) {
