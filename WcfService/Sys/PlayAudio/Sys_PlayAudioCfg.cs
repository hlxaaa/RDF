...
{
    public class Sys_PlayAudioCfg : BaseCfg
    {
        ...
        protected override void SetCfg()
        {
            ...
            AddField("专辑", "TypeId", "TypeId", ColumnType.Int, "t1", true);
            ...
            Tab = new TableInfo(@"t1.Id,t1.Title,t1.TypeId,t1.Url,t1.LongTime,t1.EditTime,t1.PlayCount,t1.Enabled","Sys_PlayAudio",true);
        }
